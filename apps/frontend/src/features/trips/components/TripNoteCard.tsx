  ...
  return (
    <>
      ...
      <div
        ...
        class={cn(
          'overflow-hidden select-none space-y-2 rounded-md border bg-gray-100 p-2 transition-colors hover:cursor-pointer hover:bg-gray-200/40 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-800/90',
          props.selected &&
