...
const ResizableHandle: Component = () => {
  ...
  return (
    <ResizablePrimitive.Handle class='data-[active]:bg-brand-blue-400 group relative z-10 flex w-px items-center justify-center bg-gray-300 transition-colors data-[orientation=vertical]:h-px data-[orientation=vertical]:w-full max-md:hidden dark:bg-gray-800'>
