...
interface SwitchButtonProps extends SwitchRootProps {
  label?: string;
  errorMessage?: string;
}

const SwitchButton: Component<PolymorphicProps<'div', SwitchButtonProps>> = (
  props
) => {
